...
class RobotImpl extends Robot {

    private String name;
    private String description;
    private int power;

    public RobotImpl(String name, String description, int power) {
        this.name = name;
...
class RobotCleaner extends RobotImpl {
...
class RobotGuardian extends RobotImpl {
...
class RobotFactory {
    ...
    /** Factory method */  /* NO factory methods detected... */
